...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  ...
                  → checks C:/Users/abhir/erp/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/Users/abhir/erp/.opencode/get-shit-done
                  → writes to C:/Users/abhir/erp/.opencode/get-shit-done/hooks/
...
```bash
INIT=$(node "C:/Users/abhir/erp/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "C:/Users/abhir/erp/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "C:/Users/abhir/erp/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```

...
- **Global scope**: `C:/Users/abhir/erp/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/abhir/erp/.opencode/notes/`)
...
2. Glob `C:/Users/abhir/erp/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/abhir/erp/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/abhir/erp/.opencode/notes/` — works in any directory
